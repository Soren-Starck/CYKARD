...
export class Popup extends ReactiveComponent {
    ...
    render(children) {
        ...
        return `<div onclick="close" class="w-full h-full z-50 backdrop-blur backdrop-brightness-50 absolute top-0 left-0"></div>
            <div class="absolute !pt-10 top-1/4 z-50 w-1/2 max-h-1/2 left-1/4 border bg-white shadow-lg rounded-lg p-4">
