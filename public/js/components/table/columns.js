...
export class Columns extends ReactiveComponent {
    ...
    render() {
        ...
        return `<div class="w-full flex justify-between">
                ...
                <div class="absolute z-50 top-0 left-0 h-full w-5 bg-gradient-to-r from-white to-transparent"></div>
                ...
                <div class="absolute z-50 top-0 right-0 h-full w-5 bg-gradient-to-r from-transparent to-white"></div>
            </div>
        `;
    }
