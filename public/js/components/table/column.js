...
export class Column extends ReactiveComponent {
    ...
    render() {
        ...
        return `<div ${canModify ? 'ondrop="drop" ondragover="allowDrop"' : ''} class="-z-20 min-w-[300px] min-h-full shadow rounded-md border-2 p-2 col-span-1 flex flex-col gap-2 group">
