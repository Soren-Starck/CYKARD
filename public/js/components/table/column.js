...
export class Column extends ReactiveComponent {
    ...
    render() {
        ...
        return `<div ${canModify ? 'ondrop="drop" ondragover="allowDrop"' : ''} class="min-w-[300px] overflow-x-hidden !max-w-[300px] min-h-full shadow rounded-md border-2 p-2 col-span-1 flex flex-col gap-2 group">
    ...
    ${canModify ? `
        <div onclick="newCard" class="group-hover:opacity-100 opacity-0 hover:bg-slate-50 transition relative bg-white shadow rounded-md border-dashed border-2 p-2 flex flex-col gap-1 hover:cursor-grab active:cursor-grabbing group overflow-x-hidden ">
